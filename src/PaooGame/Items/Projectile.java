...
public abstract class Projectile extends Item {
    ...
    public static final float DEFAULT_SPEED         = 16.0f; /*!< Viteza implicita a unu caracter.*/
    public static final int DEFAULT_PROJECTILE_WIDTH  = 8;   /*!< Latimea implicita a imaginii proiectilului.*/
    public static final int DEFAULT_PROJECTILE_HEIGHT = 8;   /*!< Inaltimea implicita a imaginii proiectilului.*/
